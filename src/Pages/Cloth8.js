...
import styles from "../css/Cloth8.module.css"
                            ...
                            <div className={styles.cards}>
                                <div className={styles.card}>
                                    ...
                                    <div className={styles.card_bottom}>
                                        ...
                                        <div className={styles.card_price_discounted}>105 000</div>
                                        </div>
                                        
                                        <p className={styles.card_title}>Топ открытый женский</p>
