...
import styles from "../css/Denim.module.css"
            ...
            <div className={styles.about}>
                <div className={styles.about_box}>
                    ...
                    <ul className={styles.nav_menu}>
                        ...
                        <li><div className={styles.border}><a href="/product" className={styles.nav_item_line}>товары</a></div></li>
                            ...
                            <div className={styles.cards}>
                                <div className={styles.card}>
                                    ...
                                    <div className={styles.card_bottom}>
                                        ...
                                        <div className={styles.card_price_discounted}>120 000</div>
                                        </div>
                                        
                                        <p className={styles.card_title}>Джинсовка с рисунком</p>
                                        <p className={styles.card_title}>Размер: L</p>
