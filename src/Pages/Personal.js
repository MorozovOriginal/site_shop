                ...
                <div className={styles.maps}>
                    ...
                    <div className={styles.user_main}>
                        ...
                        <div className={styles.user_info}>
                            ...
                            <img src={PUBLIC_URL + "/pen.png"} className={styles.pict_a} />
                            </div>
                            {/* <div className={styles.sale}>
                                <p className={styles.sale_box}>Персональная скидка <span>10%</span></p>
                            </div> */}
                        </div>
                    </div>
                    <div className={styles.options}>
                        <button className={styles.box_buy}>
                            ...
                            <div className={styles.buy_img}>
                                <img src={PUBLIC_URL + "/cart.png"} className={styles.pict_op} />
                            </div>
                        </button>
                        <div className={styles.box_deliv}>
                            ...
                            <div className={styles.buy_img}>
                                <img src={PUBLIC_URL + "/delivery.png"} className={styles.pict_op} />
                            </div>
                        </div>
                        <div className={styles.box_card}>
                            ...
                            <div className={styles.buy_img}>
                                <img src={PUBLIC_URL + "/credit-card.png"} className={styles.pict_op} />
                            </div>
                        </div>
                    </div>
