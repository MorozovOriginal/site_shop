...
import styles from "../css/Cloth6.module.css"
                            ...
                            <div className={styles.cards}>
                                <div className={styles.card}>
                                    ...
                                    <div className={styles.card_bottom}>
                                        ...
                                        <div className={styles.card_price_discounted}>145 000</div>
                                        </div>
                                        
                                        <p className={styles.card_title}>Топ с воланами</p>
